...
def plot_histograms(CurrentState: State):
    ...
    for i in range(3):
        opt_angs = {
            "TT": [60 + 40 * i, 94 + 40 * i, "X"],
            "masked_TT": [60 + 40 * i, 94 + 40 * i, "X"],
            "GWGW": [60 + 40 * i, 94 + 40 * i, "X"],
            "masked_GWGW": [60 + 40 * i, 94 + 40 * i, "X"],
            "TT_GWGW": [60 + 40 * i, 94 + 40 * i, "X"],
            "masked_TT_GWGW": [60 + 40 * i, 94 + 40 * i, "X"],
            "TGW": [60 + 40 * i, 94 + 40 * i, "X"],
            "masked_TGW": [60 + 40 * i, 94 + 40 * i, "X"],
            "TT_TGW_GWGW": [60 + 40 * i, 94 + 40 * i, "X"],
            "masked_TT_TGW_GWGW": [60 + 40 * i, 94 + 40 * i, "X"],
            "TT_TGW": [60 + 40 * i, 94 + 40 * i, "X"],
            "masked_TT_TGW": [60 + 40 * i, 94 + 40 * i, "X"],
        }
